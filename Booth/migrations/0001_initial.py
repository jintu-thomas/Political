    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booth_name', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('village_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Village.village_name')),
            ],
        ),
    ]
