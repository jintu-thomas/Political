...
class Booth_Name(models.Model):
    ...
    village_name = models.ForeignKey(Village_Name, on_delete=models.CASCADE)
    booth_name = models.CharField(max_length=64, null=True, blank=True)
